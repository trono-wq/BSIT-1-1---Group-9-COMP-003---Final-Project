...
(
    ...
    o_profile_created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
    o_last_profile_update_at DATETIME DEFAULT CURRENT_TIMESTAMP,
...
(
    ...
    o_department_updated_at DATETIME DEFAULT CURRENT_TIMESTAMP,
...
(
    ...
    employment_type_name ENUM('Full-Time', 'Part-Time', 'Contractual / Freelance')
);
...
(
    ...
    o_vacancy_updated_at DATETIME DEFAULT CURRENT_TIMESTAMP,
...
(
    ...
    o_application_updated_at DATETIME DEFAULT CURRENT_TIMESTAMP,
...
(
    ...
    o_requirement_type_added_at DATETIME DEFAULT CURRENT_TIMESTAMP,
...
(
    ...
    o_file_path TEXT,
    o_document_uploaded_at DATETIME DEFAULT CURRENT_TIMESTAMP,
...
(
    ...
    remarks TEXT,
    screened_by INT,
    o_screen_updated_at DATETIME DEFAULT CURRENT_TIMESTAMP,
...
(
    ...
    o_interview_type_added_at DATETIME DEFAULT CURRENT_TIMESTAMP,
...
(
    ...
    o_schedule_updated_at DATETIME DEFAULT CURRENT_TIMESTAMP,
...
(
    ...
    o_evaluation_updated_at DATETIME DEFAULT CURRENT_TIMESTAMP,
...
(
    ...
    o_assessment_type_added_at DATETIME DEFAULT CURRENT_TIMESTAMP,
...
(
    ...
    final_remarks TEXT,
    o_final_decision_at DATETIME DEFAULT CURRENT_TIMESTAMP,
