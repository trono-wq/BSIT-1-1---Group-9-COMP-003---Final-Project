    ...
    public partial class frmJobVacancyManagement : Form
    {
        ...
        private void LoadVacancies()
        {
            try
            {
                ...
                db.GetConnection())
                {
                    ...
                    dgvVacancies.DataSource =
                        table;

                    dgvVacancies.Columns[
                    "job_vacancy_id"]
                    .HeaderText =
                    "Job Vacancy ID";
        ...
        private void dgvVacancies_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
               ...
               .Value?.ToString());
                ...
                int employmentIndex =
                cmbEmploymentType.FindStringExact(
                row.Cells[
                "employment_type_name"]
                .Value?.ToString());
                ...
                {
                    cmbEmploymentType.SelectedIndex =
                    employmentIndex;
                }
                ...
                for (int i = 0;
                    i < clbDocuments.Items.Count; i++)
                {
                    clbDocuments.SetItemChecked(
                        i, false);
                }
                ...
                cmbStatus.Text =
                row.Cells["vacancy_status"]
                .Value?.ToString();

                txtUpdatedBy.Text =
                row.Cells["updated_by"]
                .Value?.ToString();

                txtUpdatedAt.Text =
                row.Cells["o_vacancy_updated_at"]
                .Value?.ToString();
        ...
        private void frmJobVacancyManagement_Load(object sender, EventArgs e)
        {
            ...
            db.GetConnection())
            {
                ...
                MySqlCommand departmentCmd =
                new MySqlCommand(
                departmentQuery,
                conn);

                MySqlDataReader departmentReader =
                departmentCmd.ExecuteReader();

                DataTable departmentTable =
                new DataTable();

                departmentTable.Load(
                departmentReader);
                ...
                MySqlCommand employmentCmd =
                new MySqlCommand(
                employmentQuery,
                conn);

                MySqlDataReader employmentReader =
                employmentCmd.ExecuteReader();

                DataTable employmentTable =
                new DataTable();

                employmentTable.Load(
                employmentReader);

                employmentReader.Close();

                cmbEmploymentType.DataSource =
                employmentTable;

                cmbEmploymentType.DisplayMember =
                "employment_type_name";

                cmbEmploymentType.ValueMember =
                "employment_type_id";
                ...
                @"SELECT * FROM RequirementTypes";

                MySqlCommand requirementCmd =
                new MySqlCommand(
                requirementQuery,
                conn);

                MySqlDataReader requirementReader =
                requirementCmd.ExecuteReader();

                while (
                requirementReader.Read())
                {
                    clbRequirements.Items.Add(
                    requirementReader[
        ...
        private void btnAdd_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                db.GetConnection())
                {
                    ...
                    checkCmd.Parameters.AddWithValue(
                    "@employmentTypeId", 
                    cmbEmploymentType.SelectedValue);
                    ...
                    string qualifications =
                    string.Join(", ",
                    clbRequirements.CheckedItems
                    .Cast<object>());

                    string documents =
                    string.Join(", ",
                    clbDocuments.CheckedItems
                    .Cast<object>());
